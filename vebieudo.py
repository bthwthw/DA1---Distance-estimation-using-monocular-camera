...
def draw_mre_chart(csv_path):
    ...
    plt.tight_layout()
    plt.savefig('mre_comparison_chart_stable.png', dpi=300)
    print("Đã xuất biểu đồ thành công: mre_comparison_chart_stable.png")
    plt.show()
...
def draw_comparison_chart(seq):
    ...
    plt.savefig(f'plots/comparison_chart_{seq}_stable.png')
    plt.show()

# draw_mre_chart('final_results_stable.csv')
# for i in range(21):
